...
const terminalThemes: Record<'dark' | 'light' | 'tokyo-night', ITheme> = {
  ...
  // ANSI 0–15 follow the original Tokyo Night VS Code palette exactly.
  'tokyo-night': {
...
export function terminalTheme(): ITheme {
  ...
  return terminalThemes[selected === 'light' || selected === 'tokyo-night' ? selected : 'dark']
}
