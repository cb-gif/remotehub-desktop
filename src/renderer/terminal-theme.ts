...
const terminalThemes: Record<'dark' | 'light' | 'tokyo-night' | 'tokyo-storm' | 'tokyo-light', ITheme> = {
  ...
  'tokyo-light': {
    background: '#d6d8df', foreground: '#343b58', cursor: '#707280', cursorAccent: '#d6d8df',
    selectionBackground: '#acb0bf40', selectionInactiveBackground: '#acb0bf33',
...
export function terminalTheme(): ITheme {
  ...
  return terminalThemes[selected === 'light' || selected === 'tokyo-night' || selected === 'tokyo-storm' || selected === 'tokyo-light' ? selected : 'dark']
}
